...
<div class="container mt-3">
	<h2>Employees</h2>
	<div class="container">
		<h2 align="right"><a href="<%= request.getContextPath() %>/new"><button type="submit" class="btn btn-primary">AddNewUser</button></a></h2> 
		<h2 align="left"><a href="<%= request.getContextPath() %>/list"><button type="submit" class="btn btn-primary">List employees</button></a></h2>
	</div>
